...
class TestLttngInfo:
    ...
    def test_add_tracepoints(self):
        ...
        data.add_agnocast_node(0, 0, 0, 'name', 'ns')
        ...
        data.add_agnocast_timer(0, 0, 0, 0, 0, 0, 'symbol', 0)
        data.add_agnocast_callback_group(0, 0, 0, 'type')
        ...
        data.add_agnocast_create_timer_callable_instance(0, 0, 0)
