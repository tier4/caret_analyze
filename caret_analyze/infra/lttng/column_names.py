...
class ColumnName(NamedTuple):
    ...
    CALLBACK_OBJECT_INTRA: str = 'callback_object_intra'
    CLIENT_HANDLE: str = 'client_handle'
    SERVICE_HANDLE: str = 'service_handle'
    TF_BUFFER_CORE: str = 'tf_buffer_core'
    TRANSFORM_BROADCASTER: str = 'transform_broadcaster'
    TF_BROADCASTER: str = 'tf_broadcaster'
    ...
    BUFFER_ENQUEUE_TIMESTAMP: str = 'enqueue_timestamp'
    BUFFER_DEQUEUE_TIMESTAMP: str = 'dequeue_timestamp'
    BUFFER_CLEAR_TIMESTAMP: str = 'clear_timestamp'
    BUFFER: str = 'buffer'
    PID: str = 'pid'
    TID: str = 'tid'
