...
# from caret_analyze.architecture.graph_search.graph_search import CallbackPathSearcher
...
#         node_loaded = mocker.Mock(spec=NodesStruct)
#         comm_loaded = mocker.Mock(spec=CommunicationsStruct)
#         exec_loaded = mocker.Mock(spec=ExecutorsStruct)
#         path_loaded = mocker.Mock(spec=PathsStruct)
...
#         node_loaded = mocker.Mock(spec=NodesStruct)
#         executor_loaded = mocker.Mock(spec=ExecutorsStruct)
#         path_loaded = mocker.Mock(spec=PathsStruct)
#         comm_loaded = mocker.Mock(spec=CommunicationsStruct)
...
#         loader = NodesStruct(reader_mock)
#         nodes = loader.values
#         assert len(nodes) == 0
...
#         node_mock = mocker.Mock(spec=Node)
#         cb_loaded_mock = mocker.Mock(spec=CallbacksStruct)
#         cbg_loaded_mock = mocker.Mock(spec=CallbackGroupsStruct)
#         mocker.patch.object(NodesStruct, '_create_node',
...
#         path_searched = mocker.Mock(spec=CallbackPathSearch)
...
#         cbg_loaded = mocker.Mock(spec=CallbackGroupsStruct)
...
#         var_pass_loaded = mocker.Mock(spec=VariablePassingsStruct)
...
#         cbs_loaded = mocker.Mock(spec=CallbacksStruct)
...
#         node, _, _ = NodesStruct._create_node(node_value, reader_mock)
...
#         path_created = mocker.Mock(spec=NodePathsStruct)
...
#         publishers_loaded = mocker.Mock(spec=PublishersStruct)
...
#         subscriptions_loaded = mocker.Mock(spec=SubscriptionsStruct)
...
#         timers_loaded = mocker.Mock(spec=TimersStruct)
...
#         mocker.patch.object(
#             NodesStruct, '_message_context_assigned', side_effect=assigned)

#         mocker.patch.object(
#             NodesStruct, '_search_node_paths', return_value=[path, path_])
...
#         loaded = NodesStruct(reader_mock)
...
#         nodes_loaded = NodesStruct(reader_mock)
...
#         searched = CallbackPathSearch(node_mock)
...
#         mocker.patch.object(
#             reader_mock, 'get_publishers', return_value=[])
#         callbacks_loaded_mock = mocker.Mock(spec=CallbacksStruct)
#         mocker.patch.object(callbacks_loaded_mock, 'data', [])
#         node = NodeValue('node_name', None)
#         loaded = PublishersStruct(reader_mock, callbacks_loaded_mock, node)
...
#         callbacks_loaded_mock = mocker.Mock(spec=CallbacksStruct)
#         node = NodeValue('node_name', None)
#         loaded = SubscriptionsStruct(reader_mock, callbacks_loaded_mock, node)
#         assert len(loaded.data) == 0
...
#         loaded = CallbacksStruct(reader_mock, node)
#         assert len(loaded.data) == 0
...
#             CallbacksStruct(reader_mock, node)
...
#             CallbacksStruct(reader_mock, node).data
...
#     def test_empty(self, mocker: MockerFixture):
#         reader_mock = mocker.Mock(spec=ArchitectureReader)
#         callback_loaded_mock = mocker.Mock(spec=CallbacksStruct)
...
#         write_callback = mocker.Mock(spec=CallbackStruct)
#         read_callback = mocker.Mock(spec=CallbackStruct)
...
#         nodes_loaded = mocker.Mock(NodesStruct)
#         loaded = ExecutorsStruct(reader_mock, nodes_loaded)

#         executors = loaded.values
#         assert executors == ()
...
#         nodes_loaded = mocker.Mock(spec=NodesStruct)
#         struct = ExecutorsStruct._to_struct(
...
#         exec_info = ExecutorsStruct._to_struct(
...
#         nodes_loaded_mock = mocker.Mock(spec=NodesStruct)
#         loaded = ExecutorsStruct(reader_mock, nodes_loaded_mock)
#         executors = loaded.values
...
#         mocker.patch.object(CommunicationsStruct,
...
#         comm_info: CommunicationStructValue = CommunicationsStruct._to_struct(
...
#         nodes_loaded_mock = mocker.Mock(spec=NodesStruct)
#         mocker.patch.object(nodes_loaded_mock, 'data', ())
#         comm_loaded = CommunicationsStruct(nodes_loaded_mock)
...
#         reader_mock = mocker.Mock(spec=ArchitectureReader)
#         nodes_loaded_mock = mocker.Mock(spec=NodesStruct)
#         comm_loaded_mock = mocker.Mock(spec=CommunicationsStruct)

#         mocker.patch.object(
#             reader_mock, 'get_paths', return_value=())
#         loaded = PathsStruct(
#             reader_mock, nodes_loaded_mock, comm_loaded_mock)
#         paths_info = loaded.values
#         assert paths_info == ()
...
#         path_mock = mocker.Mock(spec=PathStructValue)
#         mocker.patch.object(PathsStruct, '_to_struct',
...
#         node_path_mock = mocker.Mock(spec=NodePathStructValue)
#         mocker.patch.object(PathsStruct, '_to_node_path_struct',
...
#                      return_value=path_mock)
#         paths_info = PathsStruct._to_struct(
