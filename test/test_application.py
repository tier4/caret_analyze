    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "test/lttng_samples/talker_listener/architecture.yaml",
            ...
            (  # cyclic case
                ...
                "test/lttng_samples/cyclic_pipeline_intra_process/architecture.yaml",
            ...
            (
                ...
                "test/lttng_samples/end_to_end_sample/architecture.yaml",
            ...
            (  # publisher callback_name and callback depencency added
                "test/lttng_samples/end_to_end_sample",
                "test/lttng_samples/end_to_end_sample/architecture_modified.yaml",
                "/sensor_dummy_node/timer_callback_0",
                "/actuator_dummy_node/subscription_callback_0",
                1,
            ),
